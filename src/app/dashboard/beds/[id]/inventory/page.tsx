  ...
  return (
    <>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => router.push(`/dashboard/beds/${params.id}/features`)}
          ...
          {inventory.length > 0 ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center">
              <p className="text-gray-500 dark:text-gray-400">
                Bu yatağa henüz envanter bulunmamaktadır. Yeni envanter eklemek için "Envanter Ekle" butonunu kullanabilirsiniz.
              </p>
            </div>
          )}
        </div>
      ...
      <DeleteConfirmationModal
        ...
        message="Bu envanteri yataktan kaldırmak istediğinizden emin misiniz? Bu işlem geri alınamaz."
